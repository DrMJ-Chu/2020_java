...
public class Ex04 {
	public static void main(String[] args) {
		...
		// if문은 조건신이 boolean형이다. 즉 비교연산, 논리연산, boolean형 사용
		// switch문은 인지값이 byte, short, int, char, String 일 때 사용
		// switch(인지값)(
		// 		case 조건값1 : 인지값과 조건값1과 같을때 수행할 문장 : break;
		// 		case 조건값2 : 인지값과 조건값2과 같을때 수행할 문장 : break;
		// 		case 조건값3 : 인지값과 조건값3과 같을때 수행할 문장 : break;
		// 		deafault : 조건값 1,2,3 모두 같지 않을 때 수행할 문장 ;
		// }
