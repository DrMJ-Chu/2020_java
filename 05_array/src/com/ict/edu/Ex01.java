...
public class Ex01 {
	public static void main(String[] args) {
		...
		// 3. 데이터 저장 : 이름[방번호=index=인덱스=0부터 시작] = 저장할 데이터
		// 	  이때 자료형은 같아야 한다. (단, 작은 자료형은 큰자료형에 저장 가능)
			su[0] = 100;
			su[1] = 200;
			su[2] = 'a';
		// su[3] = 3.14; (X) // 큰자료형은 작은 자료형에 저장 할 수 없다.
			su[3] = 300 ;
			su[1] = 100 ; // 데이터 중복도 가능, 현재 데이터가 있어도 저장 가능
		...
		// 배열 전체에 대해서 정보 가공을 할 수 있으나 개별로는 변경할 수 없다.
			for (int k : su) {
